...
function AddCalendarButtonMoblieRaw() {
  ...
  if (getOperatingSystem() === 'Windows' || getOperatingSystem() === 'MacOS') {
      ...
      <>
        ...
        <Popover>
          <PopoverTrigger asChild>
            <div className="flex items-center justify-center w-12 h-12 gap-2  rounded-full border-2 hover:bg-realiti-gray-light text-realiti-gray-light font-medium hover:text-realiti-blue2">
    ...
    return (
      <>
        <div onClick={handleAddToCalendar} className="flex items-center justify-center w-12 h-12 gap-2  rounded-full border-2 hover:bg-realiti-gray-light text-realiti-gray-light font-medium hover:text-realiti-blue2">
          {/* <span>Add event to calendar</span> */}
          <CalendarDays className='-translate-y-[10%]' />
        </div>
      </>
...
const AddCalendarButtonMoblie = dynamic(() => Promise.resolve(AddCalendarButtonMoblieRaw), {
  ssr: false,
})

export default AddCalendarButtonMoblie