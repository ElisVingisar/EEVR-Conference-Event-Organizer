      ...
      <div className="relative -rotate-3">
        <div className="my-12 ">
          ...
          <div className="space-y-12">
            <ul
              role="list"
              className="space-y-12 sm:grid sm:grid-cols-2 sm:gap-x-12 sm:gap-y-18 sm:space-y-0 lg:grid-cols-4 lg:gap-x-24 gap-y-16"
            >
              {speakers.slice(0, 8).map((person, index) => {
